...
root_node <- xml2::xml_add_child(sitemap, "urlset", xml_ns = "http://www.sitemaps.org/schemas/sitemap/0.9")
...
for (rmd_file in rmd_files) {
  ...
  url_node <- xml2::xml_add_child(root_node, "url", xml_ns = "http://www.sitemaps.org/schemas/sitemap/0.9")
