...
<br>
Head on to the next lesson, in which we are going to talk about vectors (yes, we will skip for now type factor and boolean, we'll see them when they will be more useful).
