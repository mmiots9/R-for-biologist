...
<br>
You can see how having the info for each patient in a different vector is not as convenient, for this reason for expression data we use matrix. In the next chapter we will talk about them.
